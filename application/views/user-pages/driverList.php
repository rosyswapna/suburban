			...
			<table class="table table-hover table-bordered table-with-20-percent-td">
				<tbody>
					...
					<tr>
						...
						<?php echo br().form_label('Outstanding','outstanding',$attributes).nbs(2);?> :<?php if( !isset($trip_info[$det['id']]['outstanding']) || $trip_info[$det['id']]['outstanding']==''){ echo '';}else{echo nbs(2).$trip_info[$det['id']]['outstanding'];}?>
