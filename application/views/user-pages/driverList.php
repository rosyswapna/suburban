			...
			<table class="table table-hover table-bordered table-with-20-percent-td">
				<tbody>
					...
					<tr>
						...
						echo br().form_label('License','license',$attributes).nbs(2);?>: <span><?php if( !isset($drivers[$det['id']]['license_renewal_date']) || $drivers[$det['id']]['license_renewal_date']==''){ echo '';}else{echo $drivers[$det['id']]['license_renewal_date'];}?></span>
