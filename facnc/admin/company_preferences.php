	...
	if ($input_error != 1)
	{
		update_company_prefs(
			get_post( array('coy_name','coy_no','gst_no','tax_prd','tax_last',
				...
				'bcc_email','default_payment_terms'))
		);
...
$_POST['default_payment_terms']  = $myrow["default_payment_terms"];
...
payment_type_list_row(_("Payment Terms:"), 'default_payment_terms', $_POST['default_payment_terms']);
