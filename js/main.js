...
if($('.avoid-continous').val()=='true')
var continous=$('.avoid-continous').val();
var url=base_url+'/organization/front-desk/download_xl/trips?';

if(pickupdatepicker!='' || dropdatepicker!='' || vehicles!='-1' || drivers!='-1' || trip_status!='-1' || trip_id!='' ){
if(pickupdatepicker!=''){
